...
export const ArtificialHeroBackground = () => {
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      const width = canvas.width = grainCanvas.width = canvas.parentElement?.clientWidth || window.innerWidth;
      const height = canvas.height = grainCanvas.height = canvas.parentElement?.clientHeight || window.innerHeight;
