      ...
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden relative text-white min-h-[90vh] flex items-center justify-center font-sans tracking-tight">
        ...
        <div className="sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center flex flex-col items-center">
            ...
            >
              <strong className="text-white text-xl md:text-2xl font-semibold">Design Experiences That Users Love and Convert</strong>
              <p>A great design is not just about looks — it’s about results. At Abuqitmir Tech, we provide professional UI/UX design services in Pakistan to create intuitive, engaging, and conversion-focused digital experiences.</p>
            </motion.div>
          ...
          >
            ...
            <div className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">What is UI Design?</h3>
            ...
            <div className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">What is UX Design?</h3>
              <p className="text-neutral-400 text-lg leading-relaxed mb-4">
                UX (User Experience) ensures smooth usability and user satisfaction. It involves understanding the user journey to create intuitive experiences.
              </p>
              <ul className="space-y-2">
                {['User research & analysis', 'Wireframing & Prototyping', 'Seamless navigation'].map((item, idx) => (
