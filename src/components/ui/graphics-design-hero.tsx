    ...
    <>
      ...
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden relative text-white min-h-[90vh] flex items-center justify-center font-sans tracking-tight">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute text-white/5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[25vw] font-bold opacity-10 blur-sm mix-blend-overlay pointer-events-none select-none">DESIGN</div>
        ...
        <div className="sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center flex flex-col items-center">
            ...
            >
              <strong className="text-white text-xl md:text-2xl font-semibold">Stunning Visuals That Capture Your Brand's Identity</strong>
              <p>Great design speaks louder than words. At Abuqitmir Tech, we provide professional graphics design services in Pakistan to help businesses create compelling visual identities and marketing materials that resonate with their target audience.</p>
            </motion.div>
          ...
          >
            ...
            <HolographicCard className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">What is Graphics Design?</h3>
            ...
            <HolographicCard className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Complete Brand Identity</h3>
              <p className="text-neutral-400 text-lg leading-relaxed mb-4">
                We help build an identity that sets you apart from competitors.
              </p>
              <ul className="space-y-2">
                {['Logo Design & Branding', 'Social Media Graphics', 'Marketing Materials Marketing'].map((item, idx) => (
