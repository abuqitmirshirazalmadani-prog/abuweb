...
import { FileText, TrendingUp, PenTool } from 'lucide-react';

export function ContentWritingHero() {
  return (
    <>
      <style>{`
        .seo-glow {
      ...
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden relative text-white min-h-[90vh] flex items-center justify-center font-sans tracking-tight">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute text-white/5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[25vw] font-bold opacity-10 blur-sm mix-blend-overlay pointer-events-none select-none">WORDS</div>
        ...
        <div className="sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center flex flex-col items-center">
            ...
            >
              <strong className="text-white text-xl md:text-2xl font-semibold">High-Quality Content That Ranks, Engages, and Converts</strong>
              <p>Content is the foundation of online success. At Abuqitmir Tech, we provide professional content writing services in Pakistan to help businesses attract, engage, and convert their audience while supporting SEO strategies.</p>
            </motion.div>
          ...
          >
            ...
            <div className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">What is Content Writing?</h3>
              <p className="text-neutral-400 text-lg leading-relaxed">
                Content writing involves creating valuable, relevant, and engaging content for websites, blogs, and marketing, often used alongside web development services to improve performance.
              </p>
            </div>
            ...
            <div className="seo-glow bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 transition-transform duration-500 hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Beyond the Words</h3>
              <p className="text-neutral-400 text-lg leading-relaxed mb-4">
                Great content bridges the gap between what you offer and what your audience needs.
              </p>
              <ul className="space-y-2">
                {['SEO-Friendly Blog Posts', 'High-Converting Copywriting', 'Engaging Social Media Content'].map((item, idx) => (
