...
export function TextGlitch({ text, hoverText, href, className = "", delay = 0 }: TextEffectProps) {
  ...
  return (
    <h1
      ref={textRef}
      className={`
        text-2xl md:text-5xl lg:text-[5vw] font-bold leading-none tracking-tight m-0 text-center
        text-neutral-600/20
        bg-gradient-to-r from-[#5ce65c] to-[#3cff9d] bg-clip-text bg-no-repeat
